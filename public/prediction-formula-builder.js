...
@media(max-width:720px),(pointer:coarse){.pf-panel{padding:11px;border-left-width:4px}.pf-grid{grid-template-columns:1fr}.pf-grid>aside:last-child{grid-column:auto}.pf-grid>aside:first-child{max-height:none}.pf-desktop-copy{display:none!important}.pf-mobile-copy{display:block}.pf-node{grid-template-columns:minmax(0,1fr) minmax(0,1fr);grid-template-areas:"copy copy" "not remove" "mobile mobile";align-items:stretch;padding:9px}.pf-node>label,.pf-node>.pf-grab,.pf-group>header>label,.pf-group>header>.pf-grab{display:none}.pf-node>.pf-node-copy{grid-area:copy;min-width:0}.pf-node>.pf-node-copy b,.pf-node>.pf-node-copy small{overflow-wrap:anywhere;word-break:break-word}.pf-node>button[data-a="not"]{grid-area:not}.pf-node>button[data-a="del"]{grid-area:remove}.pf-node>button[data-a="not"],.pf-node>button[data-a="del"]{width:100%;min-width:0;min-height:40px;box-sizing:border-box;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;line-height:1.2;padding-inline:8px}.pf-node .pf-mobile-actions{grid-area:mobile;grid-column:auto}.pf-mobile-actions{display:flex;gap:6px;flex-wrap:wrap}.pf-mobile-actions button{min-height:38px;flex:1}.pf-group>header>.pf-mobile-actions{flex-basis:100%}.pf-group nav{width:100%}.pf-group nav button{flex:1;min-height:40px}.pf-slot{height:46px;min-height:46px;border-color:#e2e8f0;background:#fff}.pf-slot span{opacity:1;visibility:visible;color:#94a3b8}.pf-grid aside section>button{cursor:pointer;min-height:48px}.pf-library-grab{display:none}.pf-head nav{width:100%}.pf-head nav button{flex:1;min-height:40px}.pf-sheet-dialog{max-height:86vh;padding-bottom:max(14px,env(safe-area-inset-bottom))}.pf-toast{bottom:max(14px,env(safe-area-inset-bottom))}}
`;
