...
const pref=path.join(tmp,'mops-material-information');fs.mkdirSync(pref,{recursive:true});fs.writeFileSync(path.join(pref,'preflight.json'),JSON.stringify({decision:'pass'}));
