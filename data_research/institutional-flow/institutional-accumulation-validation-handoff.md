...
- `institutional-accumulation-official-disclosure-source-collection-v1`: Prompt A **COMPLETE**, Prompt B **PREREGISTERED / PENDING**.

Prompt A completion is durable; the preregistered Prompt B closeout has not yet run.
